...
<flux:sidebar sticky :collapsible="true" class="border-e border-zinc-200 bg-zinc-50">
    ...
    <flux:sidebar.nav>
        @if (auth()->user()?->isAdmin())
            ...
            <flux:sidebar.group :heading="__('Riwayat & Laporan')" expandable icon="document-chart-bar" class="grid">
            ...
            <flux:sidebar.group :heading="__('Lainnya')" expandable icon="cog-6-tooth" class="grid">
