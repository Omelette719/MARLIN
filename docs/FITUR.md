...
Alamat lokasi dipecah menjadi field-field yang terstruktur, yaitu **Jalan**, **RT**, dan **Kelurahan**. Kolom `wilayah`, yang merupakan teks gabungan seperti "Jl. X RT. Y Kel. Z", disusun secara otomatis dari ketiga field tersebut, dan dipakai di dalam Surat Pengantar maupun berbagai tampilan lain tanpa admin perlu mengetiknya secara manual sebagai teks bebas. Khusus field **RT**, hanya angka yang diperbolehkan sebagai isiannya.
