...
Test suite mencakup: alur auth (login/2FA/password confirmation), CRUD & validasi SPK, validasi pengerjaan (terima/tolak), laporan kendala & pengerjaan, temuan kondisi, laporan bulanan, peta (endpoint data JSON), audit log, notifikasi, integrasi Telegram, dan generasi PDF surat pengantar/laporan. Total 240 test, 230 aktif dan 10 di-skip di lingkungan tanpa dependency tertentu.
