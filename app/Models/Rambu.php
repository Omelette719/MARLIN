...
class Rambu extends Model
{
    ...
    /**
     * Best real photo available for this rambu: within its most recent
     * rambu_pasang, the "after" photo from its latest laporan_pengerjaan
     * always wins over the original survey photo — a laporan_pengerjaan is
     * only ever created after the survey, so once it exists it's strictly
     * newer evidence of what the sign actually looks like now. Only falls
     * back to the survey photo (and then to older rambu_pasang rows) when no
     * completed-work photo exists yet. Never the jenis_rambu icon graphic.
     */
